...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      ...
      {/* 3. Bottom Stats Bar (Premium Detail) */}
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-end border-l border-white/10 ml-6">
          <div className="pl-6">
            ...
            <p className="text-[10px] uppercase text-zinc-500 tracking-widest">Active Members</p>
          </div>
          <div className="pl-6 border-l border-white/10">
            <p className="text-3xl font-display text-white">12+</p>
            <p className="text-[10px] uppercase text-zinc-500 tracking-widest">Elite Coaches</p>
          </div>
          <div className="pl-6 border-l border-white/10">
            <p className="text-3xl font-display text-white">24/7</p>
            <p className="text-[10px] uppercase text-zinc-500 tracking-widest">Facility Access</p>
          </div>
        </div>
      </motion.div>
    </section>
